...
export const PLATFORM_ROUTING_DEFINITIONS: PlatformRoutingDefinition[] = [
  ...
  },
  {
    ...
    status: "active",
    directAffiliateLinksAllowed: true,
    policySummary: "Manual-only. Do not publish Medium through browser forms/helpers. A real image is mandatory.",
    setupBlocker: null,
    requiresCampaignLink: true,
    media: { textOnly: false, image: "required", video: "supported", notes: "AAOS ready rule: every non-video post must include a real image before approval or publish." },
  },
  {
    key: "substack",
    hebrewName: "Substack",
  ...
  },
  {
    ...
    media: { textOnly: false, image: "required", video: "supported", notes: "Use only public_review_url/bridge_url and attach a real image. No affiliate/campaign/direct tracking links in-body." },
  },
  {
    key: "reddit",
    hebrewName: "Reddit",
